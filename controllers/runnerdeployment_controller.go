...
func (r *RunnerDeploymentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if !reflect.DeepEqual(newestSet.Spec.Selector, desiredRS.Spec.Selector) {
		...
		// See https://github.com/haiau/actions-runner-controller/pull/355#discussion_r585379259
	...
	// See https://github.com/haiau/actions-runner-controller/pull/1477#issuecomment-1164154496
