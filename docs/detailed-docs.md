...
`actions-runner-controller` is an open-source project currently developed and maintained in collaboration with maintainers @mumoshu and @toast-gear, various [contributors](https://github.com/haiau/actions-runner-controller/graphs/contributors), and the [awesome community](https://github.com/haiau/actions-runner-controller/discussions), mostly in their spare time.
...
## Getting Started
To give ARC a try with just a handful of commands, Please refer to [Quick start guide](https://github.com/haiau/actions-runner-controller/blob/master/docs/QuickStartGuide.md). 
...
kubectl create -f https://github.com/haiau/actions-runner-controller/releases/download/v0.25.2/actions-runner-controller.yaml
```
...
- [Create GitHub Apps on your account](https://github.com/settings/apps/new?url=http://github.com/haiau/actions-runner-controller&webhook_active=false&public=false&administration=write&actions=read)

If you want to create a GitHub App for your organization, replace the `:org` part of the following URL with your organization name before opening it. Then enter any unique name in the "GitHub App name" field, and hit the "Create GitHub App" button at the bottom of the page to create a GitHub App.

- [Create GitHub Apps on your organization](https://github.com/organizations/:org/settings/apps/new?url=http://github.com/haiau/actions-runner-controller&webhook_active=false&public=false&administration=write&organization_self_hosted_runners=write&actions=read&checks=read)
...
> This feature requires controller version => [v0.18.0](https://github.com/haiau/actions-runner-controller/releases/tag/v0.18.0)
...
To launch a single self-hosted runner, you need to create a manifest file that includes a `RunnerDeployment` resource as follows. This example launches a self-hosted runner with name *example-runnerdeploy* for the *haiau/actions-runner-controller* repository.
...
> This feature requires controller version => [v0.20.0](https://github.com/haiau/actions-runner-controller/releases/tag/v0.20.0)
    ...
    spec:
      ...
      - name: runner
        ...
        securityContext:
          ...
          # See https://github.com/haiau/actions-runner-controller/issues/1282
...
You can also read the design and usage documentation written in the original pull request that introduced `RunnerSet` for more information [#629](https://github.com/haiau/actions-runner-controller/pull/629).
...
> If you are using controller version < [v0.22.0](https://github.com/haiau/actions-runner-controller/releases/tag/v0.22.0) and you are not using GHES, and so you can't set your rate limit budget, it is recommended that you use 100 replicas or fewer to prevent being rate limited.
...
**_Important!!! If you opt to configure autoscaling, ensure you remove the `replicas:` attribute in the `RunnerDeployment` / `RunnerSet` kinds that are configured for autoscaling [#206](https://github.com/haiau/actions-runner-controller/issues/206#issuecomment-748601907)_**
...
**Benefits of this metric**
1. Supports named repositories server-side the same as the `TotalNumberOfQueuedAndInProgressWorkflowRuns` metric [#313](https://github.com/haiau/actions-runner-controller/pull/313)
2. Supports GitHub organization wide scaling without maintaining an explicit list of repositories, this is especially useful for those that are working at a larger scale. [#223](https://github.com/haiau/actions-runner-controller/pull/223)
3. Like all scaling metrics, you can manage workflow allocation to the RunnerDeployment through the use of [GitHub labels](#runner-labels)
4. Supports scaling desired runner count on both a percentage increase / decrease basis as well as on a fixed increase / decrease count basis [#223](https://github.com/haiau/actions-runner-controller/pull/223) [#315](https://github.com/haiau/actions-runner-controller/pull/315)
...
- github.com/haiau/actions-runner-controller/config//default?ref=v0.22.2
# Add the below!
- github.com/haiau/actions-runner-controller/config//github-webhook-server?ref=v0.22.2
...
> This feature requires controller version => [v0.19.0](https://github.com/haiau/actions-runner-controller/releases/tag/v0.19.0)
...
spec:
  ...
  template:
    ...
    spec:
      ...
      # Please see https://github.com/haiau/actions-runner-controller/issues/630#issuecomment-862087323 for more information.
      volumeMounts:
      ...
      # Please see https://github.com/haiau/actions-runner-controller/pull/674 for more information.
      volumeSizeLimit: 4Gi
...
_Be sure to trigger several workflow runs before checking if the cache is effective. ARC requires an `Available` PV to be reused for the new runner pod, and a PV becomes `Available` only after some time after the previous runner pod that was using the PV terminated. See [the related discussion](https://github.com/haiau/actions-runner-controller/discussions/1605)._
...
spec:
  ...
  template:
    spec:
      repository: haiau/actions-runner-controller
      labels:
        - custom-runner
```
...
> This feature requires controller version => [v0.15.0](https://github.com/haiau/actions-runner-controller/releases/tag/v0.15.0)
...
$ helm --upgrade install haiau/actions-runner-controller \
...
> See https://github.com/haiau/actions-runner-controller/pull/1608/files#r917319574 for more information.
...
> This feature requires controller version => [v0.26.0](https://github.com/haiau/actions-runner-controller/releases/tag/v0.26.0)
