...
curl -L https://github.com/haiau/actions-runner-controller/releases/download/actions-runner-controller-${CHART_VERSION}/actions-runner-controller-${CHART_VERSION}.tgz | tar zxv --strip 1 actions-runner-controller/crds
...
helm upgrade actions-runner-controller \
  haiau/actions-runner-controller \
  --install \
